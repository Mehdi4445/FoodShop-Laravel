        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            @if(isset($guest_commenting) and $guest_commenting == true)
                <div class="form-group">
                    <label for="message">@lang('Votre nom et prénom :')</label>
                ...
                <div class="form-group">
                    <label for="message">@lang('Votre Email :')</label>
            ...
            <div class="form-group">
                <label for="message">@lang("Entrer votre feedback sur ce produit ainsi qu'une photo :")</label>
            ...
            <button type="submit" class="btn btn-sm btn-outline-success text-uppercase">@lang('Envoyer')</button>
        </form>
    </div>
</div>
<br />